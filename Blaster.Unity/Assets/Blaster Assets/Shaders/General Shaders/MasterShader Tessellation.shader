...
Shader "BlueOrbGames/TesselationCelShader"
{
	Properties
	{
		...
		_HeigthStrength1("Heigth Strength", Range( 0 , 1)) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float2 uv_HeightMap1 = v.ase_texcoord.xy * _HeightMap1_ST.xy + _HeightMap1_ST.zw;
				...
				o.ase_texcoord6.w = 0;
					...
					float3 defaultVertexValue = float3(0, 0, 0);
				#endif
				float3 vertexValue = ( ( tex2Dlod( _HeightMap1, float4( uv_HeightMap1, 0, 0.0) ) * _HeigthStrength1 ) * float4( v.ase_normal , 0.0 ) ).rgb;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
					v.vertex.xyz = vertexValue;
				#else
					v.vertex.xyz += vertexValue;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( ( float4( localAdditionalLightsLambert5_g3 , 0.0 ) + ( ( float4( _MainLightColor.rgb , 0.0 ) * lerpResult9 ) * ( _MainLightColor.a / ( 1.0 / _Brightness ) ) ) ) + RimLight60 ) + float4( Specular87 , 0.0 ) ).rgb;
				float Alpha = 1;
				float AlphaClipThreshold = 0.5;
...
/*ASEBEGIN
Version=18301
1920;0;1920;1019;1674.738;749.058;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;108;-1160.177,-282.1854;Inherit;False;Property;_HeigthStrength1;Heigth Strength;18;0;Create;True;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;106;-1110.828,-486.8669;Inherit;True;Property;_HeightMap1;HeightMap;17;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;-771.1774,-401.1854;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;107;-975.1774,-160.1854;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;109;-466.8279,-374.8669;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C99F83EFEF5590C8E8674A09D37E3902CF8D2E3A