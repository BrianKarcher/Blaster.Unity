...
namespace BlueOrb.PlayMaker.Actions
{
    ...
    public class GetGlobalFloatVariable : BasePlayMakerAction
    {		
        [RequiredField]
		...
		private void Tick()
		{
			...
			storeResult.Value = GameStateController.Instance.GlobalVariables.FloatVariablesDict.Get(GlobalVariableName.Value);
		}
	}
}