...
namespace BlueOrb.PlayMaker.Actions
{
    ...
    public class GetGlobalBoolVariable : BasePlayMakerAction
    {		
        [RequiredField]
		...
		private void Tick()
		{
			...
			storeResult.Value = GameStateController.Instance.GlobalVariables.BoolVariablesDict.Get(GlobalVariableName.Value);
		}
	}
}